...
export default function ForgotPassword({ status, turnstileEnabled, turnstileSiteKey }: any) {
    ...
    return (
        <React.Fragment>
            <GuestLayout>
                <Head title="Forgot Password | appsah" />
                                ...
                                <Card className="mt-4">
                                    ...
                                    <Card.Body className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Reset your password for appsah</p>
