...
export default function Register({ turnstileEnabled, turnstileSiteKey, invitationToken, invitationEmail }: any) {
                    ...
                    <Container>
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                <Card className="mt-4">
                                    <Card.Body className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Create your appsah account</p>
                                        </div>
                                        <div className="p-2 mt-4">
                                            <form onSubmit={submit}>
                                                ...
                                                <div className="mb-4 mt-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the appsah 
                                                ...
                                                <div className="mt-4 text-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <Link href={route('auth.social.redirect', { provider: 'google' })} className="btn btn-danger btn-icon waves-effect waves-light"><i className="ri-google-fill fs-16"></i></Link>{" "}
                                                        <Link href={route('auth.social.redirect', { provider: 'github' })} className="btn btn-dark btn-icon waves-effect waves-light"><i className="ri-github-fill fs-16"></i></Link>{" "}
                                ...
                                <div className="mt-4 text-center">
                                    <p className="mb-0">Already have an account ? <Link href={invitationToken ? `${route('login')}?invitation_token=${invitationToken}` : route('login')} className="fw-semibold text-primary text-decoration-underline"> Signin </Link> </p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
