...
export default function ConfirmPassword() {
    ...
    return (
        <GuestLayout>
            <Head title="Confirm Password | appsah" />
                    ...
                    <Card className="mt-4">
                        <Card.Body className="p-4">
                            ...
                            <div className="user-thumb text-center">
                                <img src={user?.avatar_url || avatar1} className="rounded-circle img-thumbnail avatar-lg" alt="thumbnail" />
                                <h5 className="font-size-15 mt-3">{user?.name || 'User'}</h5>
                            </div>
